...
import trade.hry.trade.comparator.AscBigDecimalComparator;
import trade.hry.trade.comparator.DescBigDecimalComparator;
...
public class TradeRedis {
    ...
    public static List<Accountadd> aaddlists = new ArrayList();
    public static List<ExOrderInfo> eoinfolists = new ArrayList();
    ...
    public static void setSelfonePrice(EntrustTrade entrust) {
        ...
        if (entrust.getType().equals(Integer.valueOf(1))) {
            ...
            /* 121 */
            if (StringUtil.isNull(buyonePrices)) {
                /* 122 */
            ...
            /* 132 */
            if (StringUtil.isNull(sellonePrices)) {
                /* 133 */
    ...
    public static Boolean isSaveEntrustByUser(String userName) {
        ...
        /* 378 */
        if (!StringUtil.isNull(appisNoSaveEntrustByUser)) {
            /* 379 */
