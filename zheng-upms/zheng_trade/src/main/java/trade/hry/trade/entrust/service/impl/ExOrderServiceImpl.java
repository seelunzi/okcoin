...
package trade.hry.trade.entrust.service.impl;
...
import trade.hry.trade.account.service.ExDigitalmoneyAccountService;
import trade.hry.trade.model.DifCustomer;
...
public class ExOrderServiceImpl
    ...
    @Override
    public String getNewListMarket(String s, Integer integer, String s1) {
        return null;
    }
    ...
    @Override
    public void pushTotal(String s) {
